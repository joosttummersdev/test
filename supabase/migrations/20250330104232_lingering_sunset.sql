...
DROP POLICY IF EXISTS "admin_access" ON scraper_configs;
DROP POLICY IF EXISTS "admin_access" ON scraper_runs;
DROP POLICY IF EXISTS "admin_access" ON scraper_logs;
